...
\indent $\circledast$ Relation fondamentale de la statique des fluides et applications: \emph{(Signes à adapter)}
...
\indent $\circledast$ Poussée d'\textsc{Archimède}: \hspace{10mm} $\vec{\Pi}=\vec{P_A}=-\rho\,V\,\rm{g}$ \\
