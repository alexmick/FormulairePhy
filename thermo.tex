...
\indent $\circledast$ Relation fondamentale de la statique des fluides et applications:
\[\overrightarrow{\D f} = -P \overrightarrow{\D S}
...
\[TV^{\gamma -1}=\rm{cste} \hspace{15mm} PV^{\gamma}=\rm{cste'} \hspace{15mm} T^{\gamma}P^{1-\gamma}=\rm{cste''}
\]
...
\[h_2-h_1=T(v_2-v_1)\left(\frac{\D P}{\D T}\right)_{\acute{e}quilibre}\]
