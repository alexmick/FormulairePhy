...
\] %Pour avoir une idée des dimensions...
\titre{Filtres}
...
\vec{j}=nq\vec{v} \hspace{15mm} \vec{j}=\gamma\vec{E} \hspace{15mm} \rho=\frac{1}{\gamma}\ (\Omegasl.m) %unité Ohm.mètre
\hspace{10mm} \mathscr{P}_\textsc{joule}=\vec{j}\cdot \vec{E}=\gamma E^2
\]\[
\text{En série: } R=\int \frac{\rho \D l}{S} \hspace{10mm} \text{En parallèle: } G=\int \frac{\gamma \D S}{l} \hspace{5mm}
\Rightarrow \hspace{3mm} \text{Fil cylindrique: } R= \frac{\rho\; l}{S} 
\]
\newpage
\titre{Équations de \textsc{Maxwell}}
\[\div{\vec{B}(M;t)} = 0 \hspace{2cm}
\rot{E(M;t)} = - \frac{\partial \vec{B}}{\partial t}(M;t)
\]\[
\div{\vec{E}(M;t)} = \frac{\rho (M;t)}{\varepsilon_0} \hspace{2cm}
\rot{B(M;t)} = \mu_0\,\vec{j}(M;t) + \varepsilon_0 \mu_0  \frac{\partial \vec{E}}{\partial t}(M;t)
\]\[
...
\Phi=L\;i
\] \\ \\
\noindent\huge\underline{$\diamond$\ \textbf{Phénomènes de propagation}}\normalsize\vspace{5mm}\newline
\[
