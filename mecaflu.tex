...
\]
On en déduit: \textsc{Bernouilli} {\scriptsize(permanent, parfait, incompressible, LdC/irrotationnel)}
\[\rho\frac{v^2}{2}+P+\rho\,g\,z=\cste\]
\[\overrightarrow{f_{flu\rightarrow sph\grave{e}re}}=-6\pi\eta\, r\, \vec{v}\hspace{10mm}
\mathrm{Re}=\frac{r v}{\nu} \hspace{10mm}
\overrightarrow{f_{flu\rightarrow objet}}=\frac{1}{2}\rho\; v^2\, S\; C_x \ \text{(coeff trainée)}
\]
\titre{Ondes acoustiques}
\[ c^2=\frac{1}{\rho_0\chi_S} \hspace{15mm} c=\sqrt{\frac{\gamma R\,T}{M}} \hspace{15mm} P=\mathcal{Z}\,v\hspace{1em} \mathcal{Z}=\pm\rho_0c\]
\[E=\frac{1}{2}\rho_0v^2+\frac{1}{2}\chi_S p^2
\]